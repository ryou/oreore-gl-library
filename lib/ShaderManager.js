...
var ShaderManager = /** @class */ (function () {
    ...
    ShaderManager.prototype.loadShader = function (options) {
        ...
        options.customUniforms.forEach(function (uniform) {
            ...
            switch (uniform.type) {
                case 'color':
                    uniformBase = new ShaderUniform_1.ShaderUniformColor(uniform.name, new float32vector_1.Vector4(uniform.options.default[0], uniform.options.default[1], uniform.options.default[2], uniform.options.default[3]));
                    break;
                case 'vector3':
                    uniformBase = new ShaderUniform_1.ShaderUniformVector3(uniform.name, new float32vector_1.Vector3(uniform.options.default[0], uniform.options.default[1], uniform.options.default[2]));
                    break;
                case 'float':
