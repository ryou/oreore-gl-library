        ...
        this._template.material.shader.fixedUniforms.forEach(function (uniform) {
            switch (uniform.name) {
                ...
                case 'localNormal2WorldMatrix':
                    {
                        var localNormal2WorldTransform = new transform_1.Transform();
                        localNormal2WorldTransform.rotate = _this.transform.rotate;
                        _this._template.material.shader.setUniform('localNormal2WorldMatrix', localNormal2WorldTransform.matrix);
                    }
                    break;
