...
var Substance = /** @class */ (function () {
    ...
    Substance.prototype.render = function (context, indexSize) {
        ...
        var camera = CameraManager_1.CameraManager.instance.activeCamera;
        var viewMatrix = camera.transform.matrix;
        this._template.material.shader.fixedUniforms.forEach(function (uniform) {
            switch (uniform.name) {
                ...
                case 'worldCameraPosition':
                    _this._template.material.shader.setUniform('worldCameraPosition', camera.transform.position);
                    break;
                default:
