...
var textures_1 = require("./data/textures");
;
...
var TextureManager = /** @class */ (function () {
    ...
    TextureManager.prototype.loadTextures = function () {
        var _this = this;
        var promises = textures_1.textures.map(function (textureDefinition) {
            var type = textureDefinition.type;
            if (type === textures_1.TEXTURE_TYPE.NORMAL)
                return _this.loadTexture(textureDefinition);
            else if (type === textures_1.TEXTURE_TYPE.CUBEMAP)
